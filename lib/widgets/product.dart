...
import 'package:food_blaze/data/providers/restaurant_provider.dart';
import 'package:food_blaze/models/product_model.dart';
import 'package:food_blaze/utilities/navigation.dart';
import 'package:food_blaze/pages/restaurant_page.dart';
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        GestureDetector(
                            onTap: () async {
                              await productProvider.loadProductsByRestaurants(
